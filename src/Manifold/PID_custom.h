...
class PID
{
  ...
  // rewritten by Jaspor, added back-calculation
...
//   double LowpassFilter(double , double , double , double );
  ...
  double *mySetpoint;             //   PID, freeing the user from having to constantly tell us what these values are.  with pointers we'll just know.
