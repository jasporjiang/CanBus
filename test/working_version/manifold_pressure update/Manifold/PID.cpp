        ...
        double Kp, double Ki, double Kd, unsigned long SampleTime, int ControllerDirection)
{
    ...
    PID::SetOutputLimits(-50, 255);				//default output limit corresponds to //the arduino pwm limits
    PID::IntegratorAntiWindUpLimits(-50, 255); //min below 0 to allow vent
...
bool PID::Compute()
{
   ...
   if(timeChange>=SampleTime)
   {
      ...
      //   Serial.print("> myinput: "); //TODO: debugging
      //   Serial.println(input);
      //   Serial.print("> mysetpoint: "); //TODO: debugging
      //   Serial.println(*mySetpoint );
        ...
        double output;
        // PID
      //   output = kp * myError + integrator - dInputFiltered;
        
        output = kp * myError + integrator - kd * dInputFiltered;
      //   Serial.print("> raw output: "); //TODO: debugging
